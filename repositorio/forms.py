...
class DocumentoForm(forms.Form):
    ...
    title = forms.CharField(label='Titulo', max_length=100, required=True,
        validators=[validators.RegexValidator('^[a-zA-ZÑñáéíóú ]{3,100}$', message="Favor de introducir bien el titulo, evite las comas o puntos y texto mayor a 100 caracteres")],
    ...
    creator = forms.CharField(label='Autor(es)', max_length=250, required=True, 
        validators=[validators.RegexValidator("^[a-zA-ZÑñ,áéíóú ]{3,250}$", message="Favor de introducir bien el o los autores, use las comas en caso de querer anotar a mas autores y no debe exceder de los 250 caracteres")],
    ...
    contributor = forms.CharField(label='Colaborador(es)', max_length=250, required=True, 
        validators=[validators.RegexValidator('^[a-zA-ZÑñ,áéíóú ]{3,250}$', message="Favor de introducir bien el o los asesores, use las comas en caso de querer anotar a mas asesores y no debe exceder de los 250 caracteres")],
    ...
    description = forms.CharField(label='Descripción', max_length=1000, required=True, 
        validators=[validators.RegexValidator('^[a-zA-ZÑñ0-9.,\'\náéíóú ]{20,1000}$', message="Favor de introducir bien su descripción, debe tener como minimo 20 caracteres y no debe exceder de los 1000 caracteres")],
    ...
    publisher = forms.CharField(label='Editor(a)', max_length=100, required=True, 
        validators=[validators.RegexValidator('^[a-zA-ZÑñáéíóú ]{3,100}$', message="Favor de introducir bien el nombre del editor y no debe de exceder de los 100 caracteres")],
    ...
    cc = forms.CharField(label='Ingresa la licencia cc', max_length=500, required=True, 
        validators=[validators.RegexValidator('^[a-zA-Z0-9<>:."=/áéíóú\- ]{6,500}$', message="Su licencia cc es invalida")],
...
class ContactoForm(forms.Form):#formulario para el login
    ...
    name = forms.CharField(label='Nombre y apellidos', max_length=100, required=True, 
        validators=[validators.RegexValidator("^[a-zA-ZÑñáéíóú ]{3,100}$", message="Favor de introducir bien su nombre completo y no exceder a los 100 caracteres")],
